...
def get_data_dir():
    ...
    # Option 2: Default path relative to script location
...
def load_topic_model():
    ...
    model_path = get_data_path("model_dir")
...
def load_2comp_embeddings():
    """Load the pre-trained BERTopic model"""
    # Get absolute path to model directory
    data_path = get_data_path("2comp_embeddings.safetensors")
    # Explicitly specify loading from local path
...
def load_5comp_embeddings():
    """Load the pre-trained BERTopic model"""
    # Get absolute path to model directory
    data_path = get_data_path("5comp_embeddings.safetensors")
    # Explicitly specify loading from local path
    return load_file(data_path)["embeddings"]
